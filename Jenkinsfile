pipeline {
    environment {
        ...
        TERRA_DIR  = "/home/sop/Bureau/projet_devosp_1/Terraform"
        ANSIBLE_DIR = "/home/sop/Bureau/projet_devosp_1/Ansible"
    }
    agent any
    stages {
        ...
        stage('Build DB Docker image') {
            steps {
                script {
                    dbDockerImage = docker.build dbDockerImageName, "-f Dd.Dockerfile ."
                }
            }
        }
